import pytest
from services.translate_service import extract_content_zh
...
# 测试相同文本的情况
# def test_extract_content_zh_same_text():
...
#         result = extract_content_zh(old_text, new_text, "zh")
#         print(result)
#         assert result == "无差异"

# 测试新增文本的情况
# def test_extract_content_zh_added_text():
#     with app.app_context():
#         old_text = "这是一段文字"
#         new_text = "这是一段新增的文字"
#         expected_result = "新增的文字"
#         actual_result = extract_content_zh(old_text, new_text, "zh")
#         print(actual_result)
#         assert expected_result in actual_result

# 测试修改文本的情况
def test_extract_content_zh_modified_text():
    with app.app_context():
        old_text = "中国画，简单的线条绘制，雄伟的白鼠，金色的灯光效果，发光的眼睛，飘渺的插画风格，精致的笔触，精致的细节，流畅的线条插图"
...
# 测试删除文本的情况
# def test_extract_content_zh_deleted_text():
#     with app.app_context():
#         old_text = "这是一段文字"
#         new_text = "这是一"
